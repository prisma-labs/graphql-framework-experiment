...
If you haven't already, you should read the [Welcome to Nexus](../../getting-started/welcome-to-nexus) introduction.
...
1. Read [Welcome to Nexus](../../getting-started/welcome-to-nexus)

...
A [Log](#Log) that outputs at `fatal` (6) level.

## `error`

A [Log](#Log) that outputs at `error` (5) level.

## `warn`

A [Log](#Log) that outputs at `warn` (4) level.

## `info`

A [Log](#Log) that outputs at `info` (3) level.

## `debug`

A [Log](#Log) that outputs at `debug` (2) level.

## `trace`

A [Log](#Log) that outputs at `trace` (1) level.

...
Refer to the [framework Prisma plugin docs](../../../nexus-plugins/prisma#runtime-integration) for API reference and concepts. What follows here are aspects that are particular to the schema plugin only.

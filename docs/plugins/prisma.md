...
[`type`](#type) [`alias`](#alias) [`filtering`](#filtering) [`pagination`](#pagination) [`ordering`](#ordering) [`computedInputs`](#computedInputs-local)([local](#computedInputs-local) and [global](#computedInputs-global))
...
# t.model.<ListRelation>
type M {
  MRF(after: M_WhereUniqueInput, before: M_WhereUniqueInput, first: Int, last: Int, skip: Int)
}

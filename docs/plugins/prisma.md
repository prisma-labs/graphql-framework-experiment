...
`ID` scalars use `StringFilter` ([issue](https://github.com/graphql-nexus/nexus-plugin-prisma/issues/485)). We are considering a tailored `DateTime` filter ([issue](https://github.com/graphql-nexus/nexus-plugin-prisma/issues/484)).

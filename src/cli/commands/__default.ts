  ...
  async parse() {
    ...
    switch (projectType.type) {
      ...
      case 'node_project':
        ...
        console.log(
          "Looks like you are inside a node but not nexus project. Please either add nexus to this project's dependencies and re-run this command or navigate to a new empty folder that does not have a package.json file present in a parent directory."
        )
        break
      case 'unknown':

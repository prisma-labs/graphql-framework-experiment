...
S.create<{ a: R<{z: number }> }>({ fields: { a: { entryFields: { z: {} } } }})
// @ts-expect-error
S.create<{ a: R<{z: number }> }>({ fields: { a: { entryFields: {} } }})
// @ts-expect-error
...
S.create<{ a: R<{z: number }> }, { a: R<{z?: number }> }>({ fields: { a: { entryFields: {} } }})
S.create<{ a: R<{z?: number }> }, { a: R<{z?: number }> }>({ fields: { a: { entryFields: {} } }})
// ... input field spec may still be provided if desired
S.create<{ a: R<{z: number }> }, { a: R<{z?: number }> }>({ fields: { a: { entryFields: { z: {} } } }})
...
S.create<{ a: R<{z?: number }> }>({ fields: { a: { entryFields: { z: { initial: () => 1 } } } }})
// @ts-expect-error
S.create<{ a: R<{z?: number }> }>({ fields: { a: { entryFields: { z: {} } } }})

// if input field optional THEN initializer required
S.create<{ a?: R<{z: number }> }>({ fields: { a: { entryFields: { z: {} }, initial: () => ({foo:{z:1}}) } }})
// @ts-ignore-error
S.create<{ a?: R<{z: number }> }>({ fields: { a: { entryFields: { z: {} } }}})
// ... but if entry input fields all optional THEN initializer optional
S.create<{ a?: R<{z?: number }> }>({ fields: { a: { entryFields: { z: {initial: () => 1 } }  } }})
S.create<{ a?: R<{z?: number }> }>({ fields: { a: { entryFields: { z: {initial: () => 1 } }, initial: () => ({foo:{z:1}}) } }})
// REGRESSION TEST: initial must return an empety record or record of valid entries
// @ts-expect-error
S.create<{ a?: R<{z?: number }> }>({ fields: { a: { entryFields: { z: {initial: () => 1 } }, initial: () => ({foo:{z:true}}) } }})
...
// @ts-ignore-error
S.create<{ a: R<{z: number }> },  { a: R<{ z: boolean }> }>({ fields: { a: { entryFields: { z: {} } } }})
...
S.create<{ a: R<{a: number }> },  { a: R<{ a: number, b: number }> }>({ fields: { a: { entryFields: { a: {} }, mapEntryData: (input) => ({ ...input, b:1 }) } }})
// @ts-expect-error
S.create<{ a: R<{a: number }> },  { a: R<{ a: number, b: number }> }>({ fields: { a: { entryFields: { a: {} } } }})
// mapEntryData gets a representation of the data resolved from input up to then
S.create<{ a?: R<{ a?: number }> }, { a: R<{ a: number, b: number }> }>({ fields: { a: { mapEntryData: (data) => ({ a: data.a, b: data.a }), entryFields: { a: { initial: () => 1 } } } } })
// @ts-expect-error data.b is not available on the data parameter
S.create<{ a?: R<{ a?: number }> }, { a: R<{ a: number, b: number }> }>({ fields: { a: { mapEntryData: (data) => ({ a: data.a, b: data.b }), entryFields: { a: { initial: () => 1 } } } } })

// metadata
tsd.expectType<number>(S.create<{ a?: R<{z: number }> }>({ fields: { a: { entryFields: { z: {} } }}}).metadata.a.value.foobar.z.value)
tsd.expectType<number>(S.create<{ a?: R<{z: number }> }>({ fields: { a: { entryFields: { z: {} } }}}).metadata.a.initial.foobar.z.value)

// if non-pojo unioned with input entry pojo THEN input entry field spec shorthand required
S.create<{ a: R<number | {a: number }> }>({ fields: { a: { entryFields: { a: {} }, entryShorthand: (a) => ({a}) } }})
// @ts-expect-error
S.create<{ a: R<number | {a: number }> }>({ fields: { a: { entryFields: { a: {} } } }})
